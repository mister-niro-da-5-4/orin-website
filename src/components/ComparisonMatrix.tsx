...
const FEATURES: Feature[] = [
  ...
  },
  {
    ...
    competitors: {
      'Sana Learn': { level: 'none', note: 'Linear only' },
      ...
      'iSpring': { level: 'partial', note: 'Limited' },
      'Elucidat': { level: 'partial', note: 'Limited' },
    },
  },
  {
    category: 'Authoring',
    ...
    competitors: {
      ...
      'iSpring': { level: 'partial', note: 'Screen recording' },
      'Elucidat': { level: 'none' },
    },
  },
  // Intelligence
  ...
  // Accessibility
  {
    ...
    competitors: {
      ...
      'Captivate': { level: 'partial', note: 'Checker tool' },
      'Lectora': { level: 'partial', note: 'Strong (Section 508)' },
  ...
  // Output & Data
  {
    ...
    competitors: {
      ...
      'Articulate 360': { level: 'partial', note: 'Manual config' },
  ...
  },
  {
    ...
    competitors: {
      ...
      'Articulate 360': { level: 'full', note: 'SCORM, xAPI' },
      'Captivate': { level: 'full', note: 'SCORM, xAPI, AICC' },
      'Lectora': { level: 'full', note: 'SCORM, xAPI, AICC' },
      'iSpring': { level: 'full', note: 'SCORM, xAPI' },
      'Elucidat': { level: 'full', note: 'SCORM, xAPI' },
    },
  },
  // Collaboration
  {
